...
8. `STRING_SESSION` : Pyrogram Session Needed, Generate string from [@darkStringGenBot](http://t.me/darkStringGenBot) in Telegram.
...
- You can play tracks or playlists from spotify from Dark Music bot
...
- You can generate telegaph links from [@darks_telegraph_bot](http://t.me/darks_telegraph_bot) and use it here.
...
1. `STRING_SESSION2` : Pyrogram Session Needed, Generate string from [@darkStringGenBot](http://t.me/darkStringGenBot) in Telegram.
2. `STRING_SESSION3` : Pyrogram Session Needed, Generate string from [@darkStringGenBot](http://t.me/darkStringGenBot) in Telegram.
3. `STRING_SESSION4` : Pyrogram Session Needed, Generate string from [@darkStringGenBot](http://t.me/darkStringGenBot) in Telegram.
4. `STRING_SESSION5` : Pyrogram Session Needed, Generate string from [@darkStringGenBot](http://t.me/darkStringGenBot) in Telegram.
